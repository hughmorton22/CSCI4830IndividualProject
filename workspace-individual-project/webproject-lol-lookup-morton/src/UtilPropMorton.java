...
public class UtilPropMorton {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "B:\\4830\\IndividualProject\\CSCI4830IndividualProject\\workspace-individual-project\\webproject-lol-lookup-morton\\WebContent\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/webproject-lol-lookup-morton/config.properties";
