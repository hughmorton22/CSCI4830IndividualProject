...
@WebServlet("/ByBuildNameSearch")
public class ByBuildNameMorton extends HttpServlet {
   private static final long serialVersionUID = 1L;

   public ByBuildNameMorton() {
      super();
   }
   ...
   void search(String keyword, HttpServletResponse response) throws IOException {
      ...
      try {
         ...
         if (keyword.isEmpty()) {
            ...
            String selectSQL = "SELECT * FROM LolBuildsTableMorton WHERE name LIKE ?";
